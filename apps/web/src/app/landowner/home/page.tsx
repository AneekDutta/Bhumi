    ...
    <LandownerShell title="My Land & Rights">
      <div className="p-4 space-y-4 max-w-lg mx-auto pb-28">
        ...
        <div className="bg-gradient-to-br from-slate-900 via-slate-900 to-amber-950/20 border border-[#e2e8f0] rounded-2xl p-4 shadow-xl space-y-3">
          ...
          {/* Quick Metrics */}
          <div className="grid grid-cols-3 gap-2 pt-2 border-t border-[#e2e8f0]/80 text-center">
            <div className="bg-[#f4f6f9]/80 p-2.5 rounded-xl border border-[#e2e8f0]">
              <span className="text-slate-400 block text-[10px]">Registered Land</span>
              <span className="text-base font-bold text-slate-900 font-mono">{parcels.length} Parcels</span>
            </div>
            <div className="bg-[#f4f6f9]/80 p-2.5 rounded-xl border border-[#e2e8f0]">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          ...
          <Link
            ...
            className="p-4 rounded-2xl bg-gradient-to-r from-amber-600 via-amber-600 to-amber-700 hover:from-amber-500 hover:to-amber-600 text-slate-900 shadow-lg shadow-amber-950/40 border border-amber-400/30 flex items-center justify-between transition-all group"
          >
            ...
            <div className="w-8 h-8 rounded-xl bg-white/20 flex items-center justify-center text-slate-900 group-hover:translate-x-0.5 transition-transform flex-shrink-0 ml-3">
          ...
          <Link
            ...
            className="p-4 rounded-2xl bg-gradient-to-r from-emerald-600 via-emerald-600 to-teal-700 hover:from-emerald-500 hover:to-teal-600 text-slate-900 shadow-lg shadow-emerald-950/40 border border-emerald-400/30 flex items-center justify-between transition-all group"
          >
            <div className="space-y-0.5">
        ...
        <div className="space-y-2.5">
          ...
          <div className="space-y-3">
            {parcels.length === 0 ? (
              <div className="bg-white/80 border border-[#e2e8f0] rounded-2xl p-6 text-center space-y-4">
              ...
              parcels.map((parcel) => {
                ...
                return (
                  <div
                    key={pId}
                    className="bg-white border border-[#e2e8f0] rounded-2xl p-4 space-y-3 hover:border-slate-200 transition-colors shadow-lg"
                  >
                    ...
                    {/* Land Details Grid */}
                    <div className="grid grid-cols-3 gap-2 text-xs pt-2 border-t border-[#e2e8f0]/80 font-mono text-center">
                      <div className="bg-[#f4f6f9] p-2 rounded-xl border border-[#e2e8f0]">
                    ...
                    <div className="pt-1 flex items-center justify-between gap-2 border-t border-[#e2e8f0]/60">
                      <Link
                        href={`/landowner/parcels/${pId}`}
                        className="flex-1 inline-flex items-center justify-center gap-1.5 text-xs font-semibold text-slate-200 hover:text-slate-900 bg-slate-100 hover:bg-slate-700 py-2.5 px-3 rounded-xl border border-slate-200 transition-colors"
                      >
        ...
        <div className="space-y-2.5 pt-2">
          ...
          <div className="space-y-2">
            {complaints.length === 0 ? (
              <div className="bg-white/60 border border-[#e2e8f0] rounded-xl p-4 text-center text-xs text-slate-400">
              ...
              complaints.slice(0, 3).map((comp) => {
                ...
                return (
                  <Link
                    ...
                    className="block bg-white border border-[#e2e8f0] rounded-xl p-3 hover:border-slate-200 transition-colors"
                  >
                    <div className="flex items-center justify-between">
