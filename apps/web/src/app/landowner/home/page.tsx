      ...
      <div className="p-4 space-y-4 max-w-lg mx-auto pb-28">
        ...
        <div className="bg-white dark:bg-[#0D121F] border border-[#DCE2E8] dark:border-white/10 rounded-md p-4 shadow-xs space-y-3">
          <div className="flex items-center justify-between flex-wrap gap-2">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded bg-[#E8F1FA] dark:bg-sky-950/40 border border-[#B8D5E5] dark:border-sky-800/40 flex items-center justify-center text-[#0B2E59] dark:text-sky-300 font-bold text-base shrink-0">
            ...
            <span className="px-2 py-0.5 rounded text-[10px] font-mono font-bold bg-[#E8F5E9] dark:bg-emerald-950/40 text-[#1E7E34] dark:text-emerald-400 border border-[#C8E6C9] dark:border-emerald-800/50">
              Registered Citizen
            </span>
          </div>
          ...
          <div className="grid grid-cols-3 gap-3 pt-2 border-t border-[#DCE2E8] dark:border-white/10 text-center">
            <div className="p-2 bg-[#F8FAFC] dark:bg-[#07080F] border border-[#DCE2E8] dark:border-white/10 rounded-md shadow-xs border-b-2 border-b-[#0B2E59] space-y-0.5">
            ...
            <div className="p-2 bg-[#F8FAFC] dark:bg-[#07080F] border border-[#DCE2E8] dark:border-white/10 rounded-md shadow-xs border-b-2 border-b-[#0B5FA5] space-y-0.5">
            ...
            <div className="p-2 bg-[#F8FAFC] dark:bg-[#07080F] border border-[#DCE2E8] dark:border-white/10 rounded-md shadow-xs border-b-2 border-b-[#1E7E34] space-y-0.5">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          ...
          <Link
            ...
            className="p-4 rounded-md bg-white dark:bg-[#0D121F] hover:bg-slate-50 dark:hover:bg-white/5 border border-[#0B2E59] dark:border-sky-500 shadow-xs flex items-center justify-between transition-all group cursor-pointer"
          >
            ...
            <div className="w-7 h-7 rounded bg-[#E8F1FA] dark:bg-sky-950/40 text-[#0B2E59] dark:text-sky-300 flex items-center justify-center group-hover:translate-x-0.5 transition-transform shrink-0 ml-3">
          ...
          <Link
            ...
            className="p-4 rounded-md bg-white dark:bg-[#0D121F] hover:bg-slate-50 dark:hover:bg-white/5 border border-[#B36B00] dark:border-amber-500 shadow-xs flex items-center justify-between transition-all group cursor-pointer"
          >
            <div className="space-y-0.5">
            ...
            <div className="w-7 h-7 rounded bg-[#FFF8E1] dark:bg-amber-950/40 text-[#B36B00] dark:text-amber-400 flex items-center justify-center group-hover:translate-x-0.5 transition-transform shrink-0 ml-3">
              <ArrowRight className="w-4 h-4" />
            </div>
          </Link>
        </div>
            ...
            {parcels.length === 0 ? (
              ...
              parcels.map((parcel) => {
                ...
                return (
                  <div
                    key={pId}
                    className="bg-white dark:bg-[#0D121F] border border-[#DCE2E8] dark:border-white/10 rounded-md p-4 space-y-3 shadow-xs hover:border-[#0B2E59] transition-colors"
                  >
                    ...
                    <div className="flex items-start justify-between gap-2">
                      ...
                      <span className="px-2 py-0.5 rounded text-[10px] font-mono font-bold uppercase bg-[#E8F5E9] dark:bg-emerald-950/40 text-[#1E7E34] dark:text-emerald-400 border border-[#C8E6C9] dark:border-emerald-800/50">
                        {regStatus}
                      </span>
                    </div>
                    ...
                    <div className="grid grid-cols-3 gap-3 text-xs pt-2 border-t border-[#DCE2E8] dark:border-white/10 font-mono text-center">
                      <div className="p-1.5 bg-[#F8FAFC] dark:bg-[#07080F] border border-[#DCE2E8] dark:border-white/10 rounded border-b-2 border-b-[#1E7E34] space-y-0.5">
                      ...
                      <div className="p-1.5 bg-[#F8FAFC] dark:bg-[#07080F] border border-[#DCE2E8] dark:border-white/10 rounded border-b-2 border-b-[#0B2E59] dark:border-b-sky-500 space-y-0.5">
                      ...
                      <div className="p-1.5 bg-[#F8FAFC] dark:bg-[#07080F] border border-[#DCE2E8] dark:border-white/10 rounded border-b-2 border-b-[#0B5FA5] space-y-0.5">
                    ...
                    <div className="pt-1 flex items-center justify-between gap-2 border-t border-[#DCE2E8] dark:border-white/10">
                      <Link
                        ...
                        className="flex-1 inline-flex items-center justify-center gap-1.5 text-xs font-semibold text-[#0B2E59] dark:text-sky-400 hover:bg-slate-50 dark:hover:bg-white/5 bg-white dark:bg-white/[0.02] py-2 px-3 rounded border border-[#DCE2E8] dark:border-white/10 transition-colors shadow-xs"
                      >
                      ...
                      <Link
                        ...
                        className="flex-1 inline-flex items-center justify-center gap-1.5 text-xs font-semibold text-white bg-[#0B2E59] hover:bg-[#082242] py-2 px-3 rounded transition-colors shadow-xs"
                      >
        ...
        <div className="space-y-2.5 pt-2">
          ...
          <div className="space-y-2">
            {complaints.length === 0 ? (
              <div className="bg-white dark:bg-[#0D121F] border border-[#DCE2E8] dark:border-white/10 rounded-md p-4 text-center text-xs text-[#64748B] shadow-xs">
              ...
              complaints.slice(0, 3).map((comp) => {
                ...
                return (
                  <Link
                    ...
                    className="block bg-white dark:bg-[#0D121F] border border-[#DCE2E8] dark:border-white/10 rounded-md p-3 hover:border-[#0B2E59] transition-colors shadow-xs"
                  >
                    <div className="flex items-center justify-between">
                      <span className="font-bold text-[#0B5FA5] dark:text-sky-400 text-xs font-mono">
                        #{comp.complaint_id || cId.slice(0, 8)}
                      </span>
                      <span className="text-[10px] font-mono font-bold px-2 py-0.5 rounded bg-[#FFF8E1] dark:bg-amber-950/40 text-[#B36B00] dark:text-amber-400 border border-[#FFE082] dark:border-amber-800/50">
                        {comp.status}
                      </span>
                    </div>
