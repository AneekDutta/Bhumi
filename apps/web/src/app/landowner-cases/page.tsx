...
export default function LandownerCasesPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-[#E8F1FA] dark:bg-[#0B2E59]/30 border border-[#B8D5E5] dark:border-[#0B2E59] px-4 py-2.5 rounded-none flex items-center justify-between flex-wrap gap-2.5">
      ...
      <div className="flex items-center justify-between flex-wrap gap-4">
        <div>
          <div className="flex items-center gap-2 mb-1">
            <span className="text-[10px] font-mono font-bold px-2 py-0.5 rounded-none bg-emerald-100 dark:bg-emerald-950/50 text-[#1E7E34] dark:text-emerald-400 border border-emerald-300 dark:border-emerald-800 uppercase">
        ...
        <div className="flex items-center gap-2.5">
          <Link
            href="/landowner-gis"
            className="px-3.5 py-2 rounded-none bg-white dark:bg-white/5 border border-[#DCE2E8] dark:border-white/10 text-[#0B2E59] dark:text-sky-400 text-xs font-semibold hover:bg-slate-50 dark:hover:bg-white/10 flex items-center gap-1.5 transition-colors"
          >
          ...
          <Link
            ...
            className="px-3.5 py-2 rounded-none bg-[#0B2E59] hover:bg-[#082242] text-white text-xs font-semibold flex items-center gap-1.5 transition-colors"
          >
      ...
      {/* Real Statistics Metrics - Flat Government Form Ledger */}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3.5">
        ...
        <div className="pb-3 pt-1 px-1 bg-transparent rounded-none border-b-2 border-[#B36B00]">
          ...
          <div className="text-2xl font-bold text-[#B36B00] dark:text-amber-400 mt-1 font-mono">
            {pendingInitiation}
          </div>
        ...
        <div className="pb-3 pt-1 px-1 bg-transparent rounded-none border-b-2 border-[#0B5FA5]">
          ...
          <div className="text-2xl font-bold text-[#0B5FA5] dark:text-sky-400 mt-1 font-mono">
            {inProgress}
          </div>
        ...
        <div className="pb-3 pt-1 px-1 bg-transparent rounded-none border-b-2 border-[#0B2E59] dark:border-sky-500">
          ...
          <div className="text-2xl font-bold text-[#0B2E59] dark:text-white mt-1 font-mono">
            {completed}
          </div>
          <div className="text-[11px] text-[#64748B] dark:text-slate-400 mt-0.5">Statutory awards disbursed</div>
        </div>

        <div className="pb-3 pt-1 px-1 bg-transparent rounded-none border-b-2 border-[#14213D] dark:border-slate-500">
          <div className="text-[11px] font-bold text-[#555555] dark:text-slate-400 uppercase tracking-wider">Disputed Area</div>
          <div className="text-2xl font-bold text-[#14213D] dark:text-white mt-1 font-mono">
