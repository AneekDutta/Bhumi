...
function LandownerCasesContent() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-[#E8F1FA] dark:bg-[#0B2E59]/30 border border-[#B8D5E5] dark:border-[#0B2E59] px-4 py-2.5 rounded-md flex items-center justify-between flex-wrap gap-2.5">
      ...
      <div className="flex items-center justify-between flex-wrap gap-4">
        ...
        <div className="flex items-center gap-2.5">
          <Link
            href="/landowner-gis"
            className="px-3.5 py-2 rounded bg-white dark:bg-white/5 border border-[#DCE2E8] dark:border-white/10 text-[#0B2E59] dark:text-sky-400 text-xs font-semibold hover:bg-slate-50 dark:hover:bg-white/10 flex items-center gap-1.5 transition-colors shadow-xs"
          >
          ...
          <Link
            ...
            className="px-3.5 py-2 rounded bg-[#0B2E59] hover:bg-[#082242] text-white text-xs font-semibold flex items-center gap-1.5 transition-colors shadow-xs"
          >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3.5">
        ...
        <div className="p-3 bg-white dark:bg-[#0D121F] border border-[#DCE2E8] dark:border-white/10 rounded-md shadow-xs border-b-2 border-b-[#14213D] dark:border-b-slate-500">
