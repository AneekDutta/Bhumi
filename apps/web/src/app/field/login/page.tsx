...
const DEMO_OFFICERS: Officer[] = [
  ...
  },
  {
    officer_id: "OFF-002",
    name: "Anita Sharma",
    designation: "Field Cadastral Surveyor",
  ...
  },
  {
    officer_id: "OFF-003",
    name: "Sanjay Verma",
    designation: "Naib Tehsildar (Dispute Adjudication)",
    department_name: "Land Acquisition Authority",
    assigned_villages: ["All Corridor Sectors"],
    pending_tasks_count: 9
  },
  {
    officer_id: "OFF-004",
    name: "Rajesh Kumar",
    designation: "Field Verification Officer (CALA)",
...
export default function FieldLoginPage() {
  ...
  const handleFormLogin = (e: React.FormEvent) => {
    ...
    if (!match && !officerId.toUpperCase().startsWith("OF")) {
      setErrorMsg("Officer ID not recognized. Use demo ID OFF-001 or select from the demo profiles below.");
      return;
    }
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col justify-between p-4 selection:bg-emerald-500/30">
      <div className="w-full max-w-md mx-auto space-y-5 pt-4 pb-12">
        ...
        {/* ========================================================================= */}
        {/* FEATURE: INSTANT 1-TAP DEMO LOGIN HERO CARD                              */}
        {/* ========================================================================= */}
        <div className="bg-gradient-to-br from-emerald-950/50 via-slate-900 to-slate-900 border-2 border-emerald-500/40 rounded-2xl p-4 shadow-xl shadow-emerald-950/30 space-y-3">
          <div className="flex items-center justify-between">
            <span className="inline-flex items-center gap-1.5 text-[10px] font-mono uppercase tracking-widest text-emerald-400 font-bold bg-emerald-500/10 px-2 py-0.5 rounded-full border border-emerald-500/30">
              <Zap className="w-3 h-3 text-emerald-400" /> 1-Tap Demo Access
            </span>
          ...
          <div className="space-y-1">
            <h2 className="text-base font-bold text-white">
              Instant Field Officer Demo
            </h2>
            <p className="text-xs text-slate-300 leading-relaxed">
              Login immediately as <strong className="text-emerald-300">Ramesh Patel (Patwari)</strong> with 6 pre-loaded parcels, live GPS simulation, and 2 critical boundary disputes.
            </p>
          </div>
          ...
          >
            {loading ? (
              ...
              <>
                ...
                <span>Launch Demo Field Console</span>
        ...
        {/* ========================================================================= */}
        {/* MODE 1: SELECT FROM PRE-CONFIGURED DEMO PROFILES                          */}
        {/* ========================================================================= */}
        {loginMode === "DEMO" && (
          ...
          <div className="bg-slate-900/90 border border-slate-800 rounded-2xl p-5 shadow-lg space-y-4">
            ...
            <div className="pt-2 border-t border-slate-800 text-center">
              ...
              >
                ...
                <span>[ Auto-Fill Demo Credentials (OFF-001 / 1234) ]</span>
              </button>
            </div>
          </div>
        )}
