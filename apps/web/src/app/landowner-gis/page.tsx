            ...
            <div className="rounded-[4px] border border-[#DCE2E8] dark:border-white/10 bg-white dark:bg-[#0D121F] p-4 shadow-xs flex flex-col gap-3">
              ...
              <div className="pt-1">
                <button
                  ...
                  className="w-full py-2.5 px-3.5 rounded bg-[#0B2E59] hover:bg-[#082242] text-white text-xs font-bold shadow-xs flex items-center justify-center gap-2 cursor-pointer transition-all"
                >
