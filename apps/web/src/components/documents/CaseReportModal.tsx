          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-[#5A6A80] dark:text-slate-400">
                Case Tracking ID: <strong className="text-[#14213D] dark:text-slate-200 font-mono">{reportData.complaintId}</strong> &middot; RFCTLARR Act 2013 Decision-Support Model
              </p>
            </div>
          </div>
