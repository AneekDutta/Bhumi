...
export function SubmissionStatusModal({
  ...
  return (
    <div className="max-w-lg mx-auto p-4 space-y-4">
      <div className="bg-white dark:bg-[#0D121F] border border-[#DCE2E8] dark:border-white/10 rounded-md p-6 text-center shadow-xs space-y-4">
        ...
        {response.offline && (
          <div className="bg-[#FFF8E1] dark:bg-amber-950/40 border border-[#FFE082] dark:border-amber-800/40 rounded-md p-3 text-left text-xs text-[#B36B00] dark:text-amber-300 flex items-start gap-2.5 shadow-xs">
        ...
        {!response.offline && (
          <div className="bg-[#F8FAFC] dark:bg-[#07080F] border border-[#DCE2E8] dark:border-white/10 rounded-md p-4 text-left space-y-3 shadow-xs">
            ...
            <div className="grid grid-cols-2 gap-2 text-xs">
              <div className="bg-white dark:bg-[#0D121F] p-2.5 rounded border border-[#DCE2E8] dark:border-white/10 shadow-xs">
            ...
            {response.is_critical_path && (
              <div className="flex items-center gap-2 bg-[#FFEBEE] dark:bg-rose-950/40 border border-[#FFCDD2] dark:border-rose-800/40 rounded p-2.5 text-[#B32424] dark:text-rose-300 text-xs font-medium">
            ...
            {response.recommended_action && (
              <div className="text-[11px] text-slate-700 dark:text-slate-300 bg-white dark:bg-[#0D121F] p-2.5 rounded border border-[#DCE2E8] dark:border-white/10">
        ...
        <div className="pt-2 space-y-2">
          <button
            onClick={onDone}
            className="w-full py-2.5 px-4 bg-[#1E7E34] hover:bg-[#166527] text-white rounded text-xs font-bold shadow-xs transition-colors flex items-center justify-center gap-2 cursor-pointer"
          >
            Return to Field Queue
          </button>
          <Link
            href={`/parcels/${parcelId}`}
            className="w-full py-2 px-4 bg-white dark:bg-white/5 hover:bg-[#F4F6F8] dark:hover:bg-white/10 text-[#0B2E59] dark:text-slate-200 border border-[#DCE2E8] dark:border-white/10 rounded text-xs font-semibold transition-colors flex items-center justify-center gap-1.5 shadow-xs"
          >
